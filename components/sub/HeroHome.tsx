...
const HeroHome = () => {
  ...
  return (
    <div className="flex flex-col md:flex-row items-center justify-between w-full min-h-screen px-4 md:px-20 gap-10">
      <div className="w-full md:w-1/2 text-white z-20 pointer-events-auto pl-12 md:pl-16">
      ...
      <div className="relative w-[350px] h-[350px] md:w-[350px] md:h-[350px] transform -translate-x-48">
        <Image
          src="/profile3.jpg"
          alt="Profile picture"
          fill
